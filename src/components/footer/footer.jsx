    ...
    return(
        <div id="footer">
            <div className="upper">
                <div className="logo">
                    <h2>Foodhut</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita necessitatibus laboriosam rerum.</p>
                    <div className="icons">
                ...
                <div className="contact">
                    <h3>Get in touch</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda aperiam non molestias!</p>
                    <div className="form">
